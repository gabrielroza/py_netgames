...
class ChallengeFactory:
    ...
    def __init__(self) -> None:
        self._challenges = [
            Challenge(left_jar=Jar(capacity=2, goal=-1), right_jar=Jar(capacity=3, goal=1), maximum_steps=2,
                      description="Preencher 1 no jarro direito."),
            Challenge(left_jar=Jar(capacity=6, goal=-1), right_jar=Jar(capacity=4, goal=2), maximum_steps=2,
                      description="Preencher 2 no jarro direito."),
            Challenge(left_jar=Jar(capacity=7, goal=-1), right_jar=Jar(capacity=5, goal=3), maximum_steps=2,
